...
class LIV_API FrameReciver : public rtc::VideoSinkInterface<cricket::VideoFrame>
{
...
class LIV_API FrameReciver
{
public:
	virtual void OnFrame(FrameRef frame) {};
}; 
...
public:
	...
	virtual void SetFrameReciver(FrameReciver *recv) = 0;
